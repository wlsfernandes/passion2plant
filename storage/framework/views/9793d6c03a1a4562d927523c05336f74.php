        ...
        <div class="col-md-6 col-xl-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <div>
                        <h4 class="mb-1 mt-1">$<span data-plugin="counterup">2,134,152</span></h4>
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <div>
                        <h4 class="mb-1 mt-1"><span data-plugin="counterup">254</span></h4>
                        <p class="text-muted mb-0">New Members</p>
                    </div>
                    <p class="text-muted mt-3 mb-0"><span class="text-danger me-1"><i
        ...
        <div class="col-xl-8">
            <div class="card">
                <div class="card-body">
                    <div class="float-end">
                        <div class="dropdown">
                            <a class="dropdown-toggle text-reset" href="#" id="dropdownMenuButton5"
                                ...
                                <span class="fw-semibold">Sort By:</span> <span class="text-muted">Monthly<i
                    ...
                    <h4 class="card-title mb-4">devpromaster </h4>
            ...
            <div class="card bg-primary">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-sm-8">
                            <p class="text-white font-size-18">devpromaster <b>2024 Bienal</b> Marketing Campaign <i
                        ...
                        <div class="col-sm-4">
                            <div class="mt-4 mt-sm-0">
                                <img src="<?php echo e(asset('/assets/admin/images/devpromaster-logo.png')); ?>" class="img-fluid"
                                    alt="">
                            </div>
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row align-items-center g-0 mt-3">
                        ...
                        <div class="col-sm-9">
                            <div class="progress mt-1" style="height: 6px;">
                                <div class="progress-bar progress-bar bg-purple" role="progressbar" style="width: 100%"
        ...
        <div class="col-xl-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title mb-4">Prime Members</h4>
                                ...
                                <tbody>
                                    <tr>
                                        <td style="width: 20px;"><img
                                                src="<?php echo e(asset('/assets/admin/images/users/avatar-4.jpg')); ?>"
                                    ...
                                    <tr>
                                        <td><img src="<?php echo e(asset('/assets/admin/images/users/avatar-5.jpg')); ?>"
                                                class="avatar-xs rounded-circle " alt="..."></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td><img src="<?php echo e(asset('/assets/admin/images/users/avatar-6.jpg')); ?>"
                                                class="avatar-xs rounded-circle " alt="..."></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td><img src="<?php echo e(asset('/assets/admin/images/users/avatar-7.jpg')); ?>"
                                                class="avatar-xs rounded-circle " alt="..."></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td><img src="<?php echo e(asset('/assets/admin/images/users/avatar-8.jpg')); ?>"
                                                class="avatar-xs rounded-circle " alt="..."></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td><img src="<?php echo e(asset('/assets/admin/images/users/avatar-2.jpg')); ?>"
                                                class="avatar-xs rounded-circle " alt="..."></td>
                                        <td>
                                            <h6 class="font-size-15 mb-1 fw-normal">Marie Kim</h6>
                                            <p class="text-muted font-size-13 mb-0"><i class="mdi mdi-map-marker"></i>
                                    ...
                                    <tr>
                                        <td><img src="<?php echo e(asset('/assets/admin/images/users/avatar-1.jpg')); ?>"
                                                class="avatar-xs rounded-circle " alt="..."></td>
                                        <td>
                                            <h6 class="font-size-15 mb-1 fw-normal">Sonya Henshaw</h6>
        ...
        <div class="col-xl-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title">Social Source Engagement</h4>
                    ...
                    <div class="text-center">
                        ...
                        <h5><a href="#" class="text-reset ">Facebook - <span class="text-muted font-16">12390
                                    paginations</span> </a></h5>
                    ...
                    <div class="row mt-4">
                        <div class="col-4">
                            <div class="social-source text-center mt-3">
                                ...
                                <p class="text-muted mb-0">12500</p>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="social-source text-center mt-3">
                        ...
                        <div class="col-4">
                            <div class="social-source text-center mt-3">
                                ...
                                <p class="text-muted mb-0">1240</p>
                            </div>
                        </div>
                    </div>
