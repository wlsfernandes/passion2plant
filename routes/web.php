...
Route::middleware(['auth', 'verified', 'can:access-website-admin'])->group(function () {
    ...
    Route::delete('pages/{page}/sections/{section}/videos/{video}', [SectionController::class, 'destroyVideo'])->name('pages.sections.videos.destroy');
    ...
    Route::get('/admin/media/{media}/download', [MediaController::class, 'download'])->name('media.download');
