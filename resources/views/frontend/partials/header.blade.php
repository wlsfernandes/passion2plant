...
<div class="header__top overhid">
    ...
    <li>
                        ...
                        <img src="{{ asset('/assets/admin/images/flags/us.jpg')}}" alt="user-image" class="me-1" height="16"> <span class="align-middle"></span>
                    </a>
                    </li>
                    <li>
                        <a href="{{ url('/lang/es') }}"
                           class="{{ app()->getLocale() === 'es' ? 'active' : '' }}">
                            <img src="{{ asset('/assets/admin/images/flags/spain.jpg')}}" alt="user-image" class="me-1" height="16"> <span class="align-middle"></span>
                        </a>
                    </li>
</ul>
        </div>
