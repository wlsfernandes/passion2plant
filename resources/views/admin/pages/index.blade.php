            ...
            <tr>
              ...
              <td class="align-middle text-center">
                <div class="d-flex flex-column align-items-center justify-content-center">
                  @if ($page->image_url)
                    <a href="{{ route('admin.images.preview', ['model' => 'pages', 'id' => $page->id]) }}" target="_blank"
                      title="View image">
                      <img src="{{ route('admin.images.preview', ['model' => 'pages', 'id' => $page->id]) }}"
                        alt="Page image" class="rounded-circle mb-1" style="width:80px;height:80px;object-fit:cover;">
                    </a>
                  @else
