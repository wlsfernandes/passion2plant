    ...
    <div class="card border border-primary">
        ...
        <div class="card-body">
            ...
            <div class="bg-info bg-opacity-10 text-info small p-3 rounded mb-4">
                ...
                • Choose an <strong>Image Type</strong> below. This tells the system whether to <strong>crop</strong> (for
                banners/cards)
                or <strong>fit</strong> (for regular images) to avoid stretching.<br>
                • To keep your content safe: for cropped types (like banners), keep important text/faces
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <select name="image_type" class="form-select" required>
                        ...
                        <option value="logo" {{ old('image_type', $defaultType) === 'logo' ? 'selected' : '' }}>
                            Logo (No Crop) — Max 400 × 120 (transparent recommended)
                        </option>
                ...
                <div class="bg-light border rounded p-3 mb-4 small">
                    ...
                    @if ($selectedType === 'banner')
                        • We will create a <strong>1920×600</strong> banner and <strong>crop</strong> to a wide ratio (no
                        stretching).<br>
                        • Keep important content in the <strong>center</strong> to avoid losing it on crop.
                    @elseif ($selectedType === 'blog_social')
                        • We will create a <strong>1200×630</strong> image and <strong>crop</strong> to a social-friendly
                        ratio.<br>
                        • Great for blog headers and sharing previews.
                    @elseif ($selectedType === 'event_header')
                        • We will create a <strong>1200×500</strong> header and <strong>crop</strong> to fit the event
                        layout.<br>
                    ...
                    @elseif ($selectedType === 'square')
                        • We will create an <strong>800×800</strong> image and <strong>crop</strong> to a perfect
                        square.<br>
                        • Best for avatars, icons, and small profile images.
                    @elseif ($selectedType === 'logo')
                        • We will create a <strong>400×120</strong> image and <strong>not crop</strong>.<br>
                        • Transparent backgrounds are recommended for logos.
                    @else
                        • We will <strong>not crop</strong>. The image will be resized to a maximum of
                        <strong>1600px</strong> on the longest side.<br>
