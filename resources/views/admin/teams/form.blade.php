    ...
    <div class="card-body">
      ...
      <form method="POST" action="{{ isset($team) ? route('teams.update', $team) : route('teams.store') }}">
        ...
        {{-- =======================
                ...
                ======================== --}}
        <div class="mb-3">
          <label class="form-label d-block">Sectors</label>

          <div class="row">
            @foreach ($sectors as $sector)
              <div class="col-md-3 col-lg-3">
                <div class="form-check mb-2">
                  <input class="form-check-input" type="checkbox" name="sectors[]" id="sector_{{ $sector->id }}"
                    value="{{ $sector->id }}"
                    {{ isset($team) && $team->sectors->contains($sector->id) ? 'checked' : '' }}>
        ...
        @isset($team)
          <div class="mb-3">
            <input type="text" class="form-control" value="{{ $team->slug }}" readonly>
            <small class="text-muted">
        ...
        {{-- =======================
                ...
                ======================== --}}
        <div class="mb-3">
          <textarea class="form-control" id="content_en" name="content_en" rows="5"
        ...
        <div class="mb-3">
          <textarea class="form-control" id="content_es" name="content_es" rows="5"
