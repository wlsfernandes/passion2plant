                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-sm-4">
                            <div class="mt-4 mt-sm-0">
                                <img src="{{ asset('/assets/admin/images/devpromaster-logo.png') }}" class="img-fluid"
                                    alt="">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless table-centered table-nowrap">
                                <tbody>
                                    ...
                                    <tr>
                                        <td><img src="{{ asset('/assets/admin/images/users/avatar-5.jpg') }}"
                                                class="avatar-xs rounded-circle " alt="..."></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td><img src="{{ asset('/assets/admin/images/users/avatar-6.jpg') }}"
                                                class="avatar-xs rounded-circle " alt="..."></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td><img src="{{ asset('/assets/admin/images/users/avatar-7.jpg') }}"
                                                class="avatar-xs rounded-circle " alt="..."></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td><img src="{{ asset('/assets/admin/images/users/avatar-8.jpg') }}"
                                                class="avatar-xs rounded-circle " alt="..."></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td><img src="{{ asset('/assets/admin/images/users/avatar-2.jpg') }}"
                                                class="avatar-xs rounded-circle " alt="..."></td>
                                        <td>
                                            <h6 class="font-size-15 mb-1 fw-normal">Marie Kim</h6>
                                            <p class="text-muted font-size-13 mb-0"><i class="mdi mdi-map-marker"></i>
                                    ...
                                    <tr>
                                        <td><img src="{{ asset('/assets/admin/images/users/avatar-1.jpg') }}"
                                                class="avatar-xs rounded-circle " alt="..."></td>
                                        <td>
                                            <h6 class="font-size-15 mb-1 fw-normal">Sonya Henshaw</h6>
