                ...
                <table width="600" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style="background:rgb(35, 173, 117); padding:20px; text-align:center; color:#ffffff;">
                            <img src="{{ asset('assets/frontend/img/icons/logo.webp') }}" alt="Passion2Plant"
                                style="max-height:60px; margin-bottom:8px; display:block; margin-left:auto; margin-right:auto;">
                    ...
                    <tr>
                        <td style="padding:30px; color:#333333; font-size:15px; line-height:1.6;">
                            ...
                            @if ($type === 'donation')
                                <p>
                                    Thank you for your generous donation. Your support helps us continue planting hope
                                    and purpose.
                                </p>
                            @else
                                <p>
                            ...
                            <!-- Amount Box -->
                            <div
                                style="margin:25px 0; padding:15px; background:#f0faf6; border-left:4px solid rgb(35, 173, 117);">
